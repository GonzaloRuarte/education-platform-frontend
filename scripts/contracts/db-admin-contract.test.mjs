...
contains("frontend source", source, "/api/setup-workbook/organization/dry-run/");
contains("frontend source", source, "/api/setup-workbook/institution/dry-run/");
contains("frontend source", source, "/api/setup-workbook/organization/draft/commit-plan/");
contains("frontend source", source, "/api/setup-workbook/institution/draft/commit-plan/");
...
contains("docker smoke", smoke, "REQUIRED_GENERIC_DATABASE_ADMIN_SMOKE_COVERAGE");
