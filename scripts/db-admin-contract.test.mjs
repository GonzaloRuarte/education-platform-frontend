...
const domSource = readFileSync(join(root, "src/dom.ts"), "utf8");
const html = readFileSync(join(root, "public/index.html"), "utf8");
const css = readFileSync(join(root, "public/styles.css"), "utf8");

const smoke = readFileSync(join(root, "scripts/docker-smoke.mjs"), "utf8");
const smokeContract = readFileSync(join(root, "scripts/frontend-browser-smoke-contract.mjs"), "utf8");
...
contains("frontend app split", app, 'from "./types"');
contains("frontend app split", app, 'from "./i18n"');
contains("frontend app split", app, 'from "./dom"');
...
notContains("frontend browser smoke contract", smokeContract, "support_pin");
notContains("frontend browser smoke contract", smokeContract, "accessibility_pin");
...
assert.ok(!source.includes("primary_key_fields[0]"), "frontend must not depend on a single primary key fallback");
