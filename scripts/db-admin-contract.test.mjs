...
contains("frontend app", app, "encodeURIComponent(schema.alias || schema.key)");
...
contains("frontend app", app, "resource_exposure_legend");
...
contains("frontend app", app, "publicErrorMessage(error, t(\"login_failed\"))");
contains("frontend app", app, "publicErrorMessage(error, t(\"load_resources_failed\"))");
contains("frontend app", app, "Request ID: ${requestId}");
...
notContains("frontend app", app, "error instanceof Error ? error.message : t(");

assert.ok(app.includes("/api/resources/${encodeURIComponent(schema.alias || schema.key)}/records/${encodeURIComponent(identity)}/?surface=${SURFACE}"), "frontend should build generic record URLs from resource alias and backend identity");
assert.ok(!app.includes("/api/resources/${schema.alias}/records/${"), "frontend must encode public aliases and identities");
