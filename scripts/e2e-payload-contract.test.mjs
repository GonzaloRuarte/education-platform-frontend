...
const validContract = {
  status: "v126_seeded_credentials_payload_builders_ready_runtime_not_executed",
  policy: {
  ...
  frontend_helper: "frontend/scripts/e2e-payload-contract.mjs",
  ...
  seeded_student_actors: [
    { key: "alpha_student_01", second_exam_support_pin_required: false, support_surface: STUDENT_SELF_SERVICE_SUPPORT_DRAWER },
  ],
  payload_case_groups: {
...
assert.equal(loaded.policy.second_exam_support_pin_required, false);
