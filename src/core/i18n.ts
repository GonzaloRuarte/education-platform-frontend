...
export const UI_TEXT: Record<string, Record<Locale, string>> = {
  ...
  student_exam_subtitle: { es: "Ingresá con tu documento/personal ID. La institución se resuelve automáticamente.", en: "Enter with your personal ID. Institution context is resolved automatically." },
  student_exam_personal_id: { es: "Documento / personal ID", en: "Personal ID" },
  student_exam_personal_id_context: { es: "El turno activo se resuelve por personal ID y la regla de no superposición de turnos.", en: "The active appointment is resolved by personal ID and the no-overlap appointment invariant." },
