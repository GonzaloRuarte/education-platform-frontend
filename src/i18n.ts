...
export const UI_TEXT: Record<string, Record<Locale, string>> = {
  ...
  student_exam_subtitle: { es: "Ingresá con tu documento/personal ID. No se pide institución ni PIN.", en: "Enter with your personal ID. No institution or PIN is requested." },
  ...
  student_exam_support_controls_help: { es: "No hay PIN adicional de soporte.", en: "There is no extra support PIN." },
