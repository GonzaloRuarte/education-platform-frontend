...
import { useGroupingStaffProfileCreate, useNavigateToGroupingStaffProfileList } from '@/mta_schools/hooks'
...
const GroupingStaffProfileCreateForm = () => {
  ...
  const create = useGroupingStaffProfileCreate()
  ...
  const onSubmit: SubmitHandler<I_FormFields> = (data) => {
    ...
    create(payload)
      .then(() => {
        successToast(sentence('Responsable de agrupamiento agregado correctamente'))
        navToList()
      })
...
export default GroupingStaffProfileCreateForm
