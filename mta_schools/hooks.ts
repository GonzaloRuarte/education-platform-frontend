...
import { creationHook, deletionHook, listHook } from '@/shared/hooks'
...
export { useNavigateToSchoolList, useSchoolCreate, useSchoolDelete, useSchoolList, useStudentProfileList }
