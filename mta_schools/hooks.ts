...
import { I_SchoolCreateRequestData, I_SchoolDetail, I_SchoolUpdateRequestData, T_SchoolId, T_SchoolsList, T_StudentProfileList } from '@/mta_schools/types'
import { axiosDelete, axiosGet, axiosPatch, axiosPost } from '@/shared/data/axios'
import { batchDeletionHook, creationHook, deletionHook, detailHookV2, listHookV2, navigationHook, navigationWithIdHook, updateHook } from '@/shared/hooks'
...
const useSchoolList = listHookV2<T_SchoolsList>(SCHOOLS_PATH, axiosGet, useAuthResources)
...
const useSchoolDetail = detailHookV2<T_SchoolId, I_SchoolDetail>(SCHOOLS_PATH, axiosGet, useAuthResources)
...
const useStudentProfileList = listHookV2<T_StudentProfileList>('/student-profile', axiosGet, useAuthResources)
