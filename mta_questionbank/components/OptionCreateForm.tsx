...
import { useMultipleChoiceOptionCreate } from '@/mta_questionbank/hooks'
import { multipleChoiceLabels } from '@/mta_questionbank/labels'
import { I_MultipleChoiceOptionCreateRequestData, T_MultipleChoiceId } from '@/mta_questionbank/types'
...
const OptionCreateForm: FC<{ multipleChoiceId: T_MultipleChoiceId; reload: T_VoidFn }> = ({
  multipleChoiceId,
  reload,
}) => {
