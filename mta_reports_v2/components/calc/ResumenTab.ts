...
export function calcResumen(
  ...
  return {
    general: {
      ...
      pct40:   { mi: r1(mean(studentScores(nonPisa, estudiantes_mi))), todos: todosRate(nonPisa, pp) },
    ...
    por_colegio: {
      bars: combo.todos.por_escuela.map(e => ({ id: e.id, p: e.pct })),
      miId: raw.colegio_meta_id,
    },
  }
}
